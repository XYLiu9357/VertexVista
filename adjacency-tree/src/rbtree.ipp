 ...
 */
template <typename key_t, typename value_t, typename Compare>
std::string RedBlackTree<key_t, value_t, Compare>::toString(const std::function<std::string(const key_t &)> &objToString, const std::string &delim, const std::string &nilStr) const
{
    if (empty())
